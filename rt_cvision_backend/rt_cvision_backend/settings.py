"""
Django settings for rt_cvision_backend project.
...
SECRET_KEY = 'django-insecure-qy!ps8i)l@f3dgiwrjdq_0dqn)l@(7v8)epp!#fy*c&09=)+@8'
...
ROOT_URLCONF = 'rt_cvision_backend.urls'
...
WSGI_APPLICATION = 'rt_cvision_backend.wsgi.application'
